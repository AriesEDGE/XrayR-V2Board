...
```
mkdir -p /etc/XrayR && wget https://cdn.jsdelivr.net/gh/AriesEDGE/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
```
...
### Install Command
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/AriesEDGE/XrayR-V2Board/install.sh)
```
